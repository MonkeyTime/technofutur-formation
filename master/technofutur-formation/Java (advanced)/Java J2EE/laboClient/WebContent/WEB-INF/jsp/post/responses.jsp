...
<html lang="en">
    ...
    <head>
        ...
        <title>${response.count} responses for subject ${subject.title}</title>
     ...
     <body>
     	<div class="row wrap30">
     		<div class="box u100"><p class="alert">${alert.message}</p></div>
     	</div>
     	<div class="row wrap30">
     		<div class="box u100">
     			Subject title and content + there responses (use javascript load more...)
     		</div>
     	</div>
	</body>
</html>