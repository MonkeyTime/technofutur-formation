...
<html lang="fr">
    ...
    <head>
    	...
    	<!--[if IE]><link rel="shortcut icon" type="image/x-icon" href="/laboClient/favicon.ico" /><![endif]-->
        ...
        <link rel="stylesheet" type="text/css" href="/laboClient/css/main.min.css" media="all">
